...
class RateLimiter:
    ...
    qaytarish cheklovini boshqaruvchi servis.
    """
    ...
    async def should_auto_reply(self, user_id: int) -> Tuple[bool, str]:
        ...
        return True, "Avto-javob yuborildi ✅"
